class NoJq{
    ...
    */
    ...
    static setListenerById(_id: string, _event: string, listener){
        NoJq.setElementListener(_event, document.getElementById(_id), listener);
    }

    static setListenerByClass(_class: string, _event: string, listener){
        let elements = document.getElementsByClassName(_class);
        for(let e of elements){
    ...
    static setListenerByTag( _tag: string, _event: string, listener){
        let elements = document.getElementsByTagName(_tag);
        for(let e of elements){
            NoJq.setElementListener(_event, e, listener);
        }
    ...
    static setListener(element: string, _event: string, listener){
        ...
        if(type=='#'){ // set by id
            NoJq.setListenerById(e, _event, listener);
        }else if(type=='.'){ // set by class
            NoJq.setListenerByClass(e, _event, listener);
        }else{
            NoJq.setListenerByTag(element, _event, listener);
        }
